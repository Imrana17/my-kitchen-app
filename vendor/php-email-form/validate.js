  ...
  function php_email_form_submit(thisForm, action, formData) {
    fetch(action, {
      ...
      .then(data => {
        ...
        data = data.trim();
        if (data === 'Your message is sent. Thank you!') {
          // Show success alert for message
          alert("Your message has been sent successfully!");
        } else if (data === 'Your booking request has been sent successfully!') {
          // Show success alert for booking
